...
* ***-filter_mode***: the filter mode for the filter on xDS nodes to be returned (e.g. prefix, suffix, regex, ...)
   * If this flag is not specified, all xDS nodes will be returned.
